...
{% endhighlight %}</div>
  ...
  <div class="row gutter">
    ...
    <div class="col-lg-6">
      ...
      <p>For more info about this positioning, including a comparison with other technologies, see <a href="https://medium.com/@aiden_ai/open-sourcing-rpc-ts-an-rpc-framework-for-typescript-255073f1fe9b" target="_blank">our open-sourcing announcement</a>.</p>
    </div>
  </div>
