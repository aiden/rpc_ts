...
import { AuthClaimsHandler, TokenValidationError } from './handler';

/**
 * The authentication claims are given in JWT as a string map.
 */
export type EncodedJwtAuthClaims = { [key: string]: string };
...
/**
 * Get an `AuthClaimsHandler` that extracts authentication claims from JWT tokens.
 *
 ...
 */
export const getJwtAuthClaimsHandler = <AuthClaims>(
  jwksUrl: string,
